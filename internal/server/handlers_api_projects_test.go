...
func TestProjectsResolveTheFeedServerSide(t *testing.T) {
	s := newTestServer(t, &config.Config{
		...
		// The rung the services below sit on has to be declared before they can
		// name it — Save refuses a service pointing at an environment nobody
		// declared. This fixture predates ValidateEnvironments; the rule is the
		// point, so the fixture moves rather than the rule.
